...
questions = [
    {
       "question": "May dalawang garapon na may lamang mga marbles. Anong kulay ng marbles ang makikita mo sa unang marbles na wala sa pangalawang garapon?",
        "choices": ["Berde", "Asul", "Pula", "Dilaw"],
        "answer": {"Berde","Asul"},
        "image": "difference jar2.png",
        "image_width": 310
    },
    {
    ...
    {
        "question": "Mayroon kang dalawang sako ng mga titik. Hanapin ang lahat ng mga titik sa sako A ngunit hindi sa sako B.",
        "choices": ["Luntian", "Dilaw",  "Asul","Lilang-lila", "Pula","Orange"],
        "answer": { "Dilaw",  "Lilang-lila"},
        "image": "difference sack.jpg",
        "image_width": 310
    },
...
if st.session_state.get('index', 0) >= 2:
    st.markdown('''
    <div style="margin-top:10px;">
        <a href="/Pages/5_Set Theory-Hamon na Tanong1" style="display:inline-block;padding:7px 16px;background:#1976d2;color:#fff;font-size:14px;font-weight:500;text-decoration:none;border-radius:8px;box-shadow:0 2px 8px rgba(25,118,210,0.10);">Nahihirapan? Tingnan muna ang Susunod na Seksyon.</a>
    </div>
    ''', unsafe_allow_html=True)
