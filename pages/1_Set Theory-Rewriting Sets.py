...
if st.session_state.get('index', 0) >= 2:
    ...
    <div style="margin-top:10px;">
        <a href="/Pages/2_Set Theory-Intersection" style="display:inline-block;padding:7px 16px;background:#1976d2;color:#fff;font-size:14px;font-weight:500;text-decoration:none;border-radius:8px;box-shadow:0 2px 8px rgba(25,118,210,0.10);">Nahihirapan? Tingnan muna ang Susunod na Seksyon.</a>
    </div>
    ''', unsafe_allow_html=True)
