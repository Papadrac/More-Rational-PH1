...
<div class="event-fixed-align">
  <div style="background:#fff; border-radius:18px; box-shadow:0 2px 16px rgba(13,35,70,0.12); padding:20px 20px; min-width:220px; max-width:280px; border:2px solid #1976d2;">
    ...
    <li><b>Meetup:</b> <a href="https://www.meetup.com/more-rational-ph/events/313632476/?eventOrigin=home_next_event_you_are_hosting" target="_blank" style="font-size:0.95em; color:#111; text-decoration:underline; font-weight:bold;">Nature of Man (Inherently Good or Evil)</a><br>
        <span style="font-size:0.85em; color:#1976d2;">Mar 21, 2026</span>
      </li>
