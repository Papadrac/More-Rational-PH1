...
<div style='margin:2em 0 2em 10em;'>
  ...
  <div style='display:flex; flex-wrap:wrap; gap:48px; justify-content:flex-start;'>
    ...
    <a href="https://morerationalph.streamlit.app/Counting-Unang_Antas" style="text-decoration:none; flex:1; min-width:320px; max-width:400px;">
      <div style='background:#0d2346; border-radius:18px; box-shadow:0 2px 16px rgba(13,35,70,0.18); padding:32px 24px; height:100%; transition:box-shadow 0.2s; cursor:pointer;'>
    ...
    <!-- Probability Course -->
    <a href="https://morerationalph.streamlit.app/Probability-Panimula" style="text-decoration:none; flex:1; min-width:320px; max-width:400px;">
      <div style='background:#0d2346; border-radius:18px; box-shadow:0 2px 16px rgba(13,35,70,0.18); padding:32px 24px; height:100%; transition:box-shadow 0.2s; cursor:pointer;'>
    ...
    <!-- Lohika Course -->
    <a href="https://morerationalph.streamlit.app/Lohika-Panimula" style="text-decoration:none; flex:1; min-width:320px; max-width:400px;">
      <div style='background:#0d2346; border-radius:18px; box-shadow:0 2px 16px rgba(13,35,70,0.18); padding:32px 24px; height:100%; transition:box-shadow 0.2s; cursor:pointer;'>
        <img src='https://imgur.com/fweNgFt.png' alt='Lohika' style='width:100%; max-width:220px; display:block; margin:auto; margin-bottom:18px; border-radius:12px; box-shadow:0 2px 8px rgba(13,35,70,0.20);'/>
