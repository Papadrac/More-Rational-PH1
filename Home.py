...
<div class="event-fixed-align">
  <div style="background:#fff; border-radius:18px; box-shadow:0 2px 16px rgba(13,35,70,0.12); padding:20px 20px; min-width:220px; max-width:280px; border:2px solid #1976d2;">
    ...
    <li><b>Meetup:</b> <a href="https://www.meetup.com/more-rational-ph/events/313408501/?slug=more-rational-ph&eventId=312940053&isFirstPublish=true" target="_blank" style="font-size:0.95em; color:#111; text-decoration:underline; font-weight:bold;">Changing Belief (Share your self realization)</a><br>
        <span style="font-size:0.85em; color:#1976d2;">Feb 28, 2026</span>
      </li>
...
<div style="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;">
  <img src="https://imgur.com/1wnMW4l.png" alt="WhatsApp Icon" style="width:34px; height:34px; object-fit:contain; vertical-align:middle;"/>
...
<div style="display: flex; align-items: center; gap: 10px; margin-bottom: 12px;">
  <img src="https://imgur.com/kc4rJmO.png" alt="Facebook Icon" style="width:34px; height:34px; object-fit:contain; vertical-align:middle;"/>
